...
- [nix-sops](https://github.com/Mic92/sops-nix), wrapper for Mozilla [secret operations](https://github.com/getsops/sops). will allow you to safely have password protected system configurations stored in public places for easy access. I suggest following the [NixOS Secrets Management](https://unmovedcentre.com/posts/secrets-management/) guide by 
